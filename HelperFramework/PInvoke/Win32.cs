...
{
	/// <summary>
	/// Win32 values, constants & structs
	/// </summary>
	public class Win32
	{
		...
		public class WM
		{
			...
			public const UInt32 THEMECHANGED = 0x031A;
			public const UInt32 DWMCOMPOSITIONCHANGED = 0x031E;
			// ...
		}
		...
		public class EM
		{
			...
			public const int SETCUEBANNER = 0x1501;
			public const int GETCUEBANNER = 0x1502;
		}
		...
		public class CB
		{
			public const uint SETCUEBANNER = 0x1703;
		}
